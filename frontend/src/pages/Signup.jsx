...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      // Fetch backend-validator errors
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 grid-bg flex flex-col justify-center items-center p-4 relative overflow-hidden">
      {/* Glow Backdrops */}
      <div className="glow-element top-[-150px] left-[-150px] w-[400px] h-[400px] bg-brand-500"></div>
      <div className="glow-element bottom-[-150px] right-[-150px] w-[400px] h-[400px] bg-indigo-500"></div>
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-2 font-light">
            Register below to shorten links and view analytics.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-3.5 bg-brand-600 hover:bg-brand-700 text-white rounded-xl font-semibold text-sm transition-all shadow-md shadow-brand-500/20 disabled:opacity-50 disabled:cursor-not-allowed mt-4 flex items-center justify-center space-x-2"
          >
            {submitting ? (
